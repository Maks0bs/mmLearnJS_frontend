...
class StudentPreview extends Component {
    ...
    componentDidMount() {
        ...
        this.props.getAttempts(this.props.exercise._id)
            .then(() => {
    ...
    onExerciseStart = (e) => {
        e.preventDefault();
        this.props.newAttempt(this.props.exercise._id)
            .then(() => {
                if (this.props.error){
                    this.props.addToast(
                        (<div>{this.props.error}</div>),
...
let mapDispatchToProps = (dispatch) => ({
    getAttempts: (exerciseId) => dispatch(getCurUserAttempts(exerciseId)),
    addToast: (toast, options) => dispatch(addToast(toast, options)),
    newAttempt: (exerciseId) => dispatch(newAttempt(exerciseId)),
